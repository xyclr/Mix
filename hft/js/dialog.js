(function() {
	...
	dialog.prototype = {
		...
		render: function() {
			...
			$('body').append( _templ.replace('{ID}', id).replace('{CSS_ISHIDE}', cfg.visible ? '': 'visibility:hidden;top:-999em;left:-999em;').replace('{TITLE}', _templ_title.replace('{TITLE}', cfg.title)).replace('{BN_CLOSE}', _templ_btn_close));
