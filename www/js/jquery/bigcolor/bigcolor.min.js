(function(a) {
    ...
    function() {
        ...
        this.init = function() {
            ...
            for (var f = 0,
            i = [], m = [], b = 0; b < d.length; b++) for (var j = o(d[b][0][0], d[b][0][1]), s = o(d[b][1][0], d[b][1][1]), a = 0; a < e; a++) b < 3 ? i[f] = o(j[a], s[a]) : m[f - e * 3] = o(j[a], s[a]),
            f++;
            for (b = 0; b < i.length; b++) k[b + 2] = i[b].concat(m[b]);
            for (b = 0; b < k.length; b++) for (a = 0; a < k[b].length; a++) {
                d = k[b];
                f = a;
                i = k[b][a];
                m = "#";
                for (c in i) j = i[c].toString(16).toUpperCase(),
                m += j.length == 1 ? "0" + j: j;
                d[f] = m
            }
        };
        this.showPicker = function(h, d, b) {
            ...
            a("#bigHexColorText").unbind("keypress").unbind("keyup").unbind("focus").keypress(function() {
                ...
                if (! (b.length <= 0)) {
                    ...
                    else if (d > 0) for (var e = 0; e < d; e++) b += "0";
                    a("#bigBgshowDiv").css("backgroundColor", b)
                }
            }).keyup(function() {
                var b = a.trim(a(this).val());
            ...
            u();
            else { (new Image).src = "../images/big_bgcolor.jpg";
                a("#bigSections").height(134).width(222).addClass("bigpicker-bgimage").empty();
                a("#bigpicker").width(247).height(183);
                var i = r(e * 3 + 2),
                m = r(e * 3);
